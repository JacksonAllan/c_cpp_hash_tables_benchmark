// c_cpp_hash_tables_benchmark/shims/ska_bytell_hash_map/shim.h
...
template< typename blueprint > struct ska_bytell_hash_map
{
  ...
  using table_type = ska::bytell_hash_map< typename blueprint::key_type, typename blueprint::value_type, hash, cmpr >;
